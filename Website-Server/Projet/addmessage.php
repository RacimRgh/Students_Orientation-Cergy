...
$db_handle = pg_connect("host=localhost dbname=dbMessage user=lyse password=juju");
...
if (isset($_POST['submit']) and !empty($_POST['submit']))
{
	...
	$datemes = $_POST['date'];
	$heuremess = $_POST['heure'];
	$etats = $_POST['admin'];
 
	$obj = new message_Class;
	$last_id = $obj->getMessageLastId();  
	$id_cleaned = $obj->getCleanedId($last_id); 
	$ret_val = $obj->createMessage($id_cleaned,$longitudes, $latitudes, $etats);
	if($ret_val === true){
            ...
            <div class="main-content-inner">
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Nouvelle Message</li>
                    </ul><!-- /.breadcrumb -->
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <form class="form-horizontal" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" name="date" id="form-field-icon-1"
                                        ...
                                        <div class="space-4"></div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right">heure</label>

                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" name="heure" id="form-field-icon-1"
                                                        class="col-xs-12 col-sm-12" />
                                                    <i class="ace-icon fa fa-cogs blue"></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="space-4"></div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right">Administrateur</label>

                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" name="admin" id="form-field-icon-1"
                                                        class="col-xs-12 col-sm-12" />
                                                    <i class="ace-icon fa fa-cogs blue"></i>
                                                </span>
                                            </div>
