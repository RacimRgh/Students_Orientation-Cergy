...
class question_Class{
    ...
    function getMessages(){             
        $sql ="SELECT Q.idq as idquest, Q.dateMess as Dateq, Q.categorie as cate, Q.contenuQ as messages, D.nom_etu as nom, D.prenom_etu as prenom, D.univ_etu as univ, D.specialite_etu as spe FROM Question as Q, Demandeur as D WHERE  D.id_dem = Q.idDem";
        return pg_query($sql);
    } 

    function getMessagesBySelect($select_search){             
        $sql ="SELECT Q.dateMess as Dateq, Q.categorie as cate, Q.contenuQ as messages, D.nom_etu as nom, D.prenom_etu as prenom, D.univ_etu as univ, D.specialite_etu as spe FROM Question as Q, Demandeur as D WHERE  Q.categorie LIKE '%".$this->cleanData($select_search)."%'";
        return pg_query($sql);
    } 
    function getMessagesByInput($input_search){             
        $sql ="SELECT Q.dateMess as Dateq, Q.categorie as cate, Q.contenuQ as messages, D.nom_etu as nom, D.prenom_etu as prenom, D.univ_etu as univ, D.specialite_etu as spe FROM Question as Q, Demandeur as D WHERE  Q.id_dem LIKE '%".$this->cleanData($input_search)."%'";
        return pg_query($sql);
    } 
