...
{
	$obj = new borne_Class;
    $ret_val = $obj->updateBorne($id,$longitudes,$latitudes,$etats);
    //var_dump($ret_val);
	if($ret_val === true){
            ...
            <div class="main-content-inner">
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Modifier la Borne</li>
                    </ul><!-- /.breadcrumb -->
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <form class="form-horizontal" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right">Id de la
                                                borne</label>

                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" readonly="" name="id" value="<?=$borne3->id_borne?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" name="latitude" value="<?=$borne3->latitude?>"
                                                        id="form-field-icon-1" class="col-xs-12 col-sm-12" />
                                                    <i class="ace-icon fa fa-cogs blue"></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" value="<?=$borne3->longitude?>" name="longitude"
                                                        id="form-field-icon-1" class="col-xs-12 col-sm-12" />
                                                    <i class="ace-icon fa fa-cogs blue"></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" value="<?=$borne3->etatb?>" name="etat"
                                                        id="form-field-icon-1" class="col-xs-12 col-sm-12" />
                                                    <i class="ace-icon fa fa-cogs blue"></i>
                                                </span>
                                            </div>
