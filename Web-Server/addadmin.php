...
if (isset($_POST['submit']) and !empty($_POST['submit']))
{
	...
	$last_id = $obj->getAdministrateurLastId();  
	$id_cleaned = $obj->getCleanedId($last_id); 
	$ret_val = $obj->createAdministrateur($id_cleaned,$roles,$noms, $prenoms, $tels);
	if($ret_val === true){
            ...
            <div class="main-content-inner">
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Nouvelle Administrateur</li>
                    </ul><!-- /.breadcrumb -->
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <form class="form-horizontal" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" name="nom" id="form-field-icon-1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" name="prenom" id="form-field-icon-1"
                                                        class="col-xs-12 col-sm-12" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <span class="input-icon">
                                                    <input type="text" name="tel" id="form-field-icon-1"
                                                        class="col-xs-12 col-sm-12" />
                                                    <i class="ace-icon fa fa-cogs blue"></i>
                                                </span>
                                            </div>
