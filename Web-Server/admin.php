...
session_start();
    ...
    $sn=1;
 	...
 	if(isset($_POST['update'])){
        //echo $_POST['id'];
        $administrateur2 = $obj->getAdministrateurById($_POST['id']);
        $_SESSION['administrateur'] = pg_fetch_object($administrateur2);
        header('location:editadmin.php');
        //var_dump($administrateur);
        //$b= $administrateur->id_administrateur;
        //echo $administrateur;
    ...
    if(isset($_POST['delete'])){
       $ret_val = $obj->deleteadministrateur($id);
       if($ret_val==1){
                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$sn++?></td>
                                                <td><?=$administrateur->idAdm?></td>
                                                <td><?=$administrateur->roleAdm?></td>
                                                <td><?=$administrateur->nomAdm?></td>
                                                <td><?=$administrateur->prenomAdm?></td>
                                                <td><?=$administrateur->telAdm?></td>
                                                <td>
                                                    <form method="post">
                                                        ...
                                                        <input type="hidden" value="<?=$administrateur->idAdm?>" name="id">
                                                    </form>
                                                    <!--div-- class="hidden-sm hidden-xs btn-group">
                                                            ...
                                                            <a class="btn btn-xs btn-info" href="editadministrateur.php?id=">
            ...
            <div class="footer-inner">
                <div class="footer-content">
                    <span class="bigger-120">
                        <span class="blue bolder">Gesadministrateur</span>
