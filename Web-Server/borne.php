...
session_start();
    ...
    $obj = new borne_Class;
    $bornes = $obj->getBornes();
    $sn=1;

 	if(isset($_POST['update'])){
        //echo $_POST['id'];
        $borne2 = $obj->getBorneById($_POST['id']);
        $_SESSION['borne'] = pg_fetch_object($borne2);
        header('location:editborne.php');
        //var_dump($borne);
        //$b= $borne->id_borne;
        //echo $borne;
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="pull-right">
                                    <a href="addborne.php" class="btn btn-success">
                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$borne->longitude?></td>
                                                <td><?=$borne->latitude?></td>
                                                <td><?=$borne->etatb?></td>
                                                <td>
                                                    <form method="post">
                                                        ...
                                                        <input type="hidden" value="<?=$borne->id_borne?>" name="id">
                                                    </form>
                                                    <!--div-- class="hidden-sm hidden-xs btn-group">
                                                            ...
                                                            <a class="btn btn-xs btn-info" href="editborne.php?id=">
